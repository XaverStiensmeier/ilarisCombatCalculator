...
testChar4 = ilarisCharacter.IlarisCharacter(name="Knight Alrik", ws=8, at=10, vt=15, ini=6, tp=(2,6,9))
testChar5 = ilarisCharacter.IlarisCharacter(name="Knight Alrik", ws=8, at=11, vt=15, ini=6, tp=(2,6,8))